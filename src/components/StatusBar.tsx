...
export const StatusBar: React.FC = () => {
  return (
    <header className="flex w-[428px] flex-col items-start absolute h-[54px] -left-px top-0 max-md:w-full max-sm:w-full">
      <div className="flex w-[430px] justify-center items-center relative px-2.5 py-0 max-md:w-full max-sm:w-full max-sm:px-[5px] max-sm:py-0">
